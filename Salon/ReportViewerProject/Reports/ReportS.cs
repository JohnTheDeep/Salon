...
namespace ReportViewerProject.Reports
{
    public partial class ReportS : Form
    {
        ...
        public ReportS(int ServId, string DateIn, string DateOut)
        {
            InitializeComponent(); 
            this.ServId = ServId;
            this.DateIn = DateIn;
