    ...
    internal class AddServiceVM : Services.PropertyChanged.PropertyChangedBase
    {
        ...
        public RelayCommand DeleteServiceCommand
        {
            get
            {
                ...
                {
                    var dialog = MessageBox.Show("Вы уверены что хотите удалить услугу?\n Все взаимосвязанные данные будут удалены!", "Подтверждение", MessageBoxButton.YesNo, MessageBoxImage.Question);
